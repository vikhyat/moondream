...
#define MOONDREAM_MAX_OUTER_PATCH_ROWS 2
#define MOONDREAM_MAX_OUTER_PATCH_COLS 2
#define MOONDREAM_MAX_IMAGE_PATCHES (MOONDREAM_MAX_OUTER_PATCH_ROWS * MOONDREAM_MAX_OUTER_PATCH_COLS)
#define MOONDREAM_IMAGE_PATCH_SIDE_LENGTH 378
#define MOONDREAM_MAX_OUTER_PATCHES 4
